...
public enum VariabilityType implements Enumerator {
	 ...
	 * @ordered
	 */
	NA(0, "na", "na"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	CONTRIBUTES(1, "contributes", "contributes"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	EXTENDS(2, "extends", "extends"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	REPLACES(3, "replaces", "replaces"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	LOCAL_CONTRIBUTION(4, "localContribution", "localContribution"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	LOCAL_REPLACEMENT(5, "localReplacement", "localReplacement"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	EXTENDS_REPLACES(6, "extendsReplaces", "extendsReplaces"); //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @generated
	 */
	private static final VariabilityType[] VALUES_ARRAY = new VariabilityType[] { NA, CONTRIBUTES, EXTENDS, REPLACES,
			LOCAL_CONTRIBUTION, LOCAL_REPLACEMENT, EXTENDS_REPLACES, };
