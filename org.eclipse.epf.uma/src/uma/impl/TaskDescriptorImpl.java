 ...
 *   <li>{@link uma.impl.TaskDescriptorImpl#getGuidanceExclude <em>Guidance Exclude</em>}</li>
 *   <li>{@link uma.impl.TaskDescriptorImpl#getGuidanceAdditional <em>Guidance Additional</em>}</li>
 ...
 *   <li>{@link uma.impl.TaskDescriptorImpl#getPerformedPrimarilyByExcluded <em>Performed Primarily By Excluded</em>}</li>
 *   <li>{@link uma.impl.TaskDescriptorImpl#getAdditionallyPerformedByExclude <em>Additionally Performed By Exclude</em>}</li>
 *   <li>{@link uma.impl.TaskDescriptorImpl#getMandatoryInputExclude <em>Mandatory Input Exclude</em>}</li>
 *   <li>{@link uma.impl.TaskDescriptorImpl#getOptionalInputExclude <em>Optional Input Exclude</em>}</li>
 *   <li>{@link uma.impl.TaskDescriptorImpl#getOutputExclude <em>Output Exclude</em>}</li>
 *   <li>{@link uma.impl.TaskDescriptorImpl#getSelectedStepsExclude <em>Selected Steps Exclude</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TaskDescriptorImpl extends WorkBreakdownElementImpl implements TaskDescriptor {
	...
	public EList<Guidance> getGuidanceExclude() {
		if (guidanceExclude == null) {
			guidanceExclude = new EObjectResolvingEList<Guidance>(Guidance.class, this, UmaPackage.TASK_DESCRIPTOR__GUIDANCE_EXCLUDE);
		}
	...
	public EList<Guidance> getGuidanceAdditional() {
		if (guidanceAdditional == null) {
			guidanceAdditional = new EObjectResolvingEList<Guidance>(Guidance.class, this, UmaPackage.TASK_DESCRIPTOR__GUIDANCE_ADDITIONAL);
		}
	 ...
	 * @generated
	 */
	public EList<Role> getPerformedPrimarilyByExcluded() {
		if (performedPrimarilyByExcluded == null) {
			performedPrimarilyByExcluded = new EObjectResolvingEList<Role>(Role.class, this, UmaPackage.TASK_DESCRIPTOR__PERFORMED_PRIMARILY_BY_EXCLUDED);
		}
	 ...
	 * @generated
	 */
	public EList<Role> getAdditionallyPerformedByExclude() {
		if (additionallyPerformedByExclude == null) {
			additionallyPerformedByExclude = new EObjectResolvingEList<Role>(Role.class, this, UmaPackage.TASK_DESCRIPTOR__ADDITIONALLY_PERFORMED_BY_EXCLUDE);
		}
	 ...
	 * @generated
	 */
	public EList<WorkProduct> getMandatoryInputExclude() {
		if (mandatoryInputExclude == null) {
			mandatoryInputExclude = new EObjectResolvingEList<WorkProduct>(WorkProduct.class, this, UmaPackage.TASK_DESCRIPTOR__MANDATORY_INPUT_EXCLUDE);
		}
	 ...
	 * @generated
	 */
	public EList<WorkProduct> getOptionalInputExclude() {
		if (optionalInputExclude == null) {
			optionalInputExclude = new EObjectResolvingEList<WorkProduct>(WorkProduct.class, this, UmaPackage.TASK_DESCRIPTOR__OPTIONAL_INPUT_EXCLUDE);
		}
	 ...
	 * @generated
	 */
	public EList<WorkProduct> getOutputExclude() {
		if (outputExclude == null) {
			outputExclude = new EObjectResolvingEList<WorkProduct>(WorkProduct.class, this, UmaPackage.TASK_DESCRIPTOR__OUTPUT_EXCLUDE);
		}
	 ...
	 * @generated
	 */
	public EList<Section> getSelectedStepsExclude() {
		if (selectedStepsExclude == null) {
			selectedStepsExclude = new EObjectResolvingEList<Section>(Section.class, this, UmaPackage.TASK_DESCRIPTOR__SELECTED_STEPS_EXCLUDE);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case UmaPackage.TASK_DESCRIPTOR__PERFORMED_PRIMARILY_BY_EXCLUDED:
				...
				getPerformedPrimarilyByExcluded().addAll((Collection<? extends Role>)newValue);
				return;
			case UmaPackage.TASK_DESCRIPTOR__ADDITIONALLY_PERFORMED_BY_EXCLUDE:
				getAdditionallyPerformedByExclude().clear();
				getAdditionallyPerformedByExclude().addAll((Collection<? extends Role>)newValue);
				return;
			case UmaPackage.TASK_DESCRIPTOR__MANDATORY_INPUT_EXCLUDE:
				getMandatoryInputExclude().clear();
				getMandatoryInputExclude().addAll((Collection<? extends WorkProduct>)newValue);
				return;
			case UmaPackage.TASK_DESCRIPTOR__OPTIONAL_INPUT_EXCLUDE:
				getOptionalInputExclude().clear();
				getOptionalInputExclude().addAll((Collection<? extends WorkProduct>)newValue);
				return;
			case UmaPackage.TASK_DESCRIPTOR__OUTPUT_EXCLUDE:
				getOutputExclude().clear();
				getOutputExclude().addAll((Collection<? extends WorkProduct>)newValue);
				return;
			case UmaPackage.TASK_DESCRIPTOR__SELECTED_STEPS_EXCLUDE:
				getSelectedStepsExclude().clear();
				getSelectedStepsExclude().addAll((Collection<? extends Section>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case UmaPackage.TASK_DESCRIPTOR__PERFORMED_PRIMARILY_BY_EXCLUDED:
				return performedPrimarilyByExcluded != null && !performedPrimarilyByExcluded.isEmpty();
			case UmaPackage.TASK_DESCRIPTOR__ADDITIONALLY_PERFORMED_BY_EXCLUDE:
				return additionallyPerformedByExclude != null && !additionallyPerformedByExclude.isEmpty();
			case UmaPackage.TASK_DESCRIPTOR__MANDATORY_INPUT_EXCLUDE:
				return mandatoryInputExclude != null && !mandatoryInputExclude.isEmpty();
			case UmaPackage.TASK_DESCRIPTOR__OPTIONAL_INPUT_EXCLUDE:
				return optionalInputExclude != null && !optionalInputExclude.isEmpty();
			case UmaPackage.TASK_DESCRIPTOR__OUTPUT_EXCLUDE:
				return outputExclude != null && !outputExclude.isEmpty();
			case UmaPackage.TASK_DESCRIPTOR__SELECTED_STEPS_EXCLUDE:
				return selectedStepsExclude != null && !selectedStepsExclude.isEmpty();
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Descriptor.class) {
			switch (derivedFeatureID) {
				...
				case UmaPackage.TASK_DESCRIPTOR__GUIDANCE_EXCLUDE: return UmaPackage.DESCRIPTOR__GUIDANCE_EXCLUDE;
				case UmaPackage.TASK_DESCRIPTOR__GUIDANCE_ADDITIONAL: return UmaPackage.DESCRIPTOR__GUIDANCE_ADDITIONAL;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Descriptor.class) {
			switch (baseFeatureID) {
				...
				case UmaPackage.DESCRIPTOR__GUIDANCE_EXCLUDE: return UmaPackage.TASK_DESCRIPTOR__GUIDANCE_EXCLUDE;
				case UmaPackage.DESCRIPTOR__GUIDANCE_ADDITIONAL: return UmaPackage.TASK_DESCRIPTOR__GUIDANCE_ADDITIONAL;
				default: return -1;
			}
		}
