 ...
 *   <li>{@link uma.impl.WorkProductDescriptorImpl#getDeliverablePartsExclude <em>Deliverable Parts Exclude</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkProductDescriptorImpl extends DescriptorImpl implements WorkProductDescriptor {
	...
	protected EClass eStaticClass() {
		return UmaPackage.eINSTANCE.getWorkProductDescriptor();
	}
	 ...
	 * @generated
	 */
	public EList<WorkProduct> getDeliverablePartsExclude() {
		if (deliverablePartsExclude == null) {
			deliverablePartsExclude = new EObjectResolvingEList<WorkProduct>(WorkProduct.class, this, UmaPackage.WORK_PRODUCT_DESCRIPTOR__DELIVERABLE_PARTS_EXCLUDE);
		}
