 ...
 * @generated
 */
public class DeliverableItemProvider extends WorkProductItemProvider {
	/**
	...
	protected void addDeliveredWorkProductsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Deliverable_deliveredWorkProducts_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_Deliverable_deliveredWorkProducts_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_Deliverable_type"), //$NON-NLS-1$
						UmaPackage.Literals.DELIVERABLE__DELIVERED_WORK_PRODUCTS, true, false, true, null, null, null));
	}
