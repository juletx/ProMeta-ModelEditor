 ...
 * @generated
 */
public class ReferenceItemProvider extends DiagramElementItemProvider {
	/**
	...
	protected void addIsIndividualRepresentationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Reference_isIndividualRepresentation_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
								"_UI_Reference_isIndividualRepresentation_feature", "_UI_Reference_type"), //$NON-NLS-1$ //$NON-NLS-2$
						UmaPackage.Literals.REFERENCE__IS_INDIVIDUAL_REPRESENTATION, true, false, false,
	...
	protected void addReferencedPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Reference_referenced_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_Reference_referenced_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_Reference_type"), //$NON-NLS-1$
						UmaPackage.Literals.REFERENCE__REFERENCED, true, false, true, null, null, null));
	}
