...
public class ProcessFamilyItemProvider extends MethodConfigurationItemProvider {
	...
	protected void addDeliveryProcessesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ProcessFamily_deliveryProcesses_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_ProcessFamily_deliveryProcesses_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_ProcessFamily_type"), //$NON-NLS-1$
						UmaPackage.Literals.PROCESS_FAMILY__DELIVERY_PROCESSES, true, false, true, null, null, null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ProcessFamily")); //$NON-NLS-1$
	}
