...
public class TeamProfileItemProvider extends BreakdownElementItemProvider {
	...
	protected void addTeamRolesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_TeamProfile_teamRoles_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_TeamProfile_teamRoles_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_TeamProfile_type"), //$NON-NLS-1$
						UmaPackage.Literals.TEAM_PROFILE__TEAM_ROLES, true, false, true, null, null, null));
	}
	...
	protected void addSuperTeamPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_TeamProfile_superTeam_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_TeamProfile_superTeam_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_TeamProfile_type"), //$NON-NLS-1$
						UmaPackage.Literals.TEAM_PROFILE__SUPER_TEAM, true, false, true, null, null, null));
	}
	...
	protected void addSubTeamPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_TeamProfile_subTeam_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_TeamProfile_subTeam_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_TeamProfile_type"), //$NON-NLS-1$
						UmaPackage.Literals.TEAM_PROFILE__SUB_TEAM, true, false, true, null, null, null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TeamProfile")); //$NON-NLS-1$
	}
