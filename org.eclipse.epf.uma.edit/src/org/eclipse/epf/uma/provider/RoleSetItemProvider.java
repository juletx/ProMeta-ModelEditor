 ...
 * @generated
 */
public class RoleSetItemProvider extends ContentCategoryItemProvider {
	/**
	...
	protected void addRolesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_RoleSet_roles_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_RoleSet_roles_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_RoleSet_type"), //$NON-NLS-1$
						UmaPackage.Literals.ROLE_SET__ROLES, true, false, true, null, null, null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RoleSet")); //$NON-NLS-1$
	}
