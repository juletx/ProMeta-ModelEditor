...
public class ContentElementItemProvider extends DescribableElementItemProvider {
	...
	protected void addSupportingMaterialsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_ContentElement_supportingMaterials_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_ContentElement_type"), //$NON-NLS-1$
				UmaPackage.Literals.CONTENT_ELEMENT__SUPPORTING_MATERIALS, true, false, true, null, null, null));
	}
	...
	protected void addConceptsAndPapersPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ContentElement_conceptsAndPapers_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_ContentElement_conceptsAndPapers_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_ContentElement_type"), //$NON-NLS-1$
						UmaPackage.Literals.CONTENT_ELEMENT__CONCEPTS_AND_PAPERS, true, false, true, null, null, null));
	}
	...
	protected void addChecklistsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ContentElement_checklists_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_ContentElement_checklists_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_ContentElement_type"), //$NON-NLS-1$
						UmaPackage.Literals.CONTENT_ELEMENT__CHECKLISTS, true, false, true, null, null, null));
	}
	...
	protected void addGuidelinesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ContentElement_guidelines_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_ContentElement_guidelines_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_ContentElement_type"), //$NON-NLS-1$
						UmaPackage.Literals.CONTENT_ELEMENT__GUIDELINES, true, false, true, null, null, null));
	}
	...
	protected void addExamplesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ContentElement_examples_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_ContentElement_examples_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_ContentElement_type"), //$NON-NLS-1$
						UmaPackage.Literals.CONTENT_ELEMENT__EXAMPLES, true, false, true, null, null, null));
	}
	...
	protected void addAssetsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ContentElement_assets_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_ContentElement_assets_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_ContentElement_type"), //$NON-NLS-1$
						UmaPackage.Literals.CONTENT_ELEMENT__ASSETS, true, false, true, null, null, null));
	}
	...
	protected void addTermdefinitionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ContentElement_termdefinition_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_ContentElement_termdefinition_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_ContentElement_type"), //$NON-NLS-1$
						UmaPackage.Literals.CONTENT_ELEMENT__TERMDEFINITION, true, false, true, null, null, null));
	}
