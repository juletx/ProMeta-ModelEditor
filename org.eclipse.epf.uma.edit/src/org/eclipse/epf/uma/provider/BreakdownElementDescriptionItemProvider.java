...
public class BreakdownElementDescriptionItemProvider extends ContentDescriptionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BreakdownElementDescription_usageGuidance_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BreakdownElementDescription_usageGuidance_feature", "_UI_BreakdownElementDescription_type"),
				 UmaPackage.eINSTANCE.getBreakdownElementDescription_UsageGuidance(),
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BreakdownElementDescription"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_BreakdownElementDescription_type") :
			getString("_UI_BreakdownElementDescription_type") + " " + label;
	}
