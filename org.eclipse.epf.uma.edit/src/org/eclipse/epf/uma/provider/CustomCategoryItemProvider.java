...
public class CustomCategoryItemProvider extends ContentCategoryItemProvider {
	...
	protected void addCategorizedElementsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_CustomCategory_categorizedElements_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_CustomCategory_type"), //$NON-NLS-1$
				UmaPackage.Literals.CUSTOM_CATEGORY__CATEGORIZED_ELEMENTS, true, false, true, null, null, null));
	}
	...
	protected void addSubCategoriesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_CustomCategory_subCategories_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_CustomCategory_subCategories_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_CustomCategory_type"), //$NON-NLS-1$
						UmaPackage.Literals.CUSTOM_CATEGORY__SUB_CATEGORIES, true, false, true, null, null, null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CustomCategory")); //$NON-NLS-1$
	}
