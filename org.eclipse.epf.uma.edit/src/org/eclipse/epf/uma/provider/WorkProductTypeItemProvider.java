...
public class WorkProductTypeItemProvider extends ContentCategoryItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_WorkProductType_workProducts_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_WorkProductType_workProducts_feature", "_UI_WorkProductType_type"),
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WorkProductType"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_WorkProductType_type") :
			getString("_UI_WorkProductType_type") + " " + label;
	}
