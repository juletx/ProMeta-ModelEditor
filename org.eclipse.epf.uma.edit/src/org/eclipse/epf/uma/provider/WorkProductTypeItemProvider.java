...
public class WorkProductTypeItemProvider extends ContentCategoryItemProvider {
	...
	protected void addWorkProductsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_WorkProductType_workProducts_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_WorkProductType_workProducts_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_WorkProductType_type"), //$NON-NLS-1$
						UmaPackage.Literals.WORK_PRODUCT_TYPE__WORK_PRODUCTS, true, false, true, null, null, null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WorkProductType")); //$NON-NLS-1$
	}
