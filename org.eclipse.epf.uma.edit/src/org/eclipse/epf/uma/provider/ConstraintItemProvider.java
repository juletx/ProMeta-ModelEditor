 ...
 * @generated
 */
public class ConstraintItemProvider extends MethodElementItemProvider {
	/**
	...
	protected void addBodyPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Constraint_body_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_Constraint_body_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_Constraint_type"), //$NON-NLS-1$
						UmaPackage.Literals.CONSTRAINT__BODY, true, false, false,
