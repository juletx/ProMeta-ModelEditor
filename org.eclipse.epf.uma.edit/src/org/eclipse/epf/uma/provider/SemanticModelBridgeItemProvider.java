	...
	protected void addPresentationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_SemanticModelBridge_presentation_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_SemanticModelBridge_presentation_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_SemanticModelBridge_type"), //$NON-NLS-1$
						UmaPackage.Literals.SEMANTIC_MODEL_BRIDGE__PRESENTATION, true, false, false,
