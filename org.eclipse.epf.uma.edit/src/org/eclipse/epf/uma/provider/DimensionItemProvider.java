...
public class DimensionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addWidthPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Dimension_width_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_Dimension_width_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_Dimension_type"), //$NON-NLS-1$
						UmaPackage.Literals.DIMENSION__WIDTH, true, false, false,
	...
	protected void addHeightPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Dimension_height_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_Dimension_height_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_Dimension_type"), //$NON-NLS-1$
						UmaPackage.Literals.DIMENSION__HEIGHT, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
