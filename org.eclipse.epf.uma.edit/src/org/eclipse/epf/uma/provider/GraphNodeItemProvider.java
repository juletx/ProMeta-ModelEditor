 ...
 * @generated
 */
public class GraphNodeItemProvider extends GraphElementItemProvider {
	/**
	...
	protected void addSizePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_GraphNode_size_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_GraphNode_size_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_GraphNode_type"), //$NON-NLS-1$
						UmaPackage.Literals.GRAPH_NODE__SIZE, true, false, true, null, null, null));
	}
