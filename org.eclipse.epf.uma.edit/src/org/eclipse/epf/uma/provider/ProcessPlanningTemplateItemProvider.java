...
public class ProcessPlanningTemplateItemProvider extends ProcessItemProvider {
	...
	protected void addBasedOnProcessesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_ProcessPlanningTemplate_basedOnProcesses_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_ProcessPlanningTemplate_type"), //$NON-NLS-1$
				UmaPackage.Literals.PROCESS_PLANNING_TEMPLATE__BASED_ON_PROCESSES, true, false, true, null, null,
				null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ProcessPlanningTemplate")); //$NON-NLS-1$
	}
