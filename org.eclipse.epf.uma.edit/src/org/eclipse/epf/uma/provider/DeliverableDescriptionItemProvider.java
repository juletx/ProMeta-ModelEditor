...
public class DeliverableDescriptionItemProvider extends WorkProductDescriptionItemProvider {
	...
	protected void addExternalDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
						"_UI_DeliverableDescription_externalDescription_feature", "_UI_DeliverableDescription_type"), //$NON-NLS-1$ //$NON-NLS-2$
				UmaPackage.Literals.DELIVERABLE_DESCRIPTION__EXTERNAL_DESCRIPTION, true, false, false,
	...
	protected void addPackagingGuidancePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_DeliverableDescription_packagingGuidance_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_DeliverableDescription_type"), //$NON-NLS-1$
				UmaPackage.Literals.DELIVERABLE_DESCRIPTION__PACKAGING_GUIDANCE, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DeliverableDescription")); //$NON-NLS-1$
	}
