...
public class MethodElementPropertyItemProvider extends PackageableElementItemProvider {
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_MethodElementProperty_value_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_MethodElementProperty_value_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_MethodElementProperty_type"), //$NON-NLS-1$
						UmaPackage.Literals.METHOD_ELEMENT_PROPERTY__VALUE, true, false, false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MethodElementProperty")); //$NON-NLS-1$
	}
