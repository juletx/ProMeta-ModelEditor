...
public class RoleDescriptionItemProvider extends ContentDescriptionItemProvider {
	...
	protected void addSkillsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_RoleDescription_skills_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_RoleDescription_skills_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_RoleDescription_type"), //$NON-NLS-1$
						UmaPackage.Literals.ROLE_DESCRIPTION__SKILLS, true, false, false,
	...
	protected void addAssignmentApproachesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_RoleDescription_assignmentApproaches_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
								"_UI_RoleDescription_assignmentApproaches_feature", "_UI_RoleDescription_type"), //$NON-NLS-1$ //$NON-NLS-2$
						UmaPackage.Literals.ROLE_DESCRIPTION__ASSIGNMENT_APPROACHES, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addSynonymsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_RoleDescription_synonyms_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_RoleDescription_synonyms_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_RoleDescription_type"), //$NON-NLS-1$
						UmaPackage.Literals.ROLE_DESCRIPTION__SYNONYMS, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RoleDescription")); //$NON-NLS-1$
	}
