 ...
 * @generated
 */
public class ToolItemProvider extends ContentCategoryItemProvider {
	/**
	...
	protected void addToolMentorsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Tool_toolMentors_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_Tool_toolMentors_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_Tool_type"), //$NON-NLS-1$
						UmaPackage.Literals.TOOL__TOOL_MENTORS, true, false, true, null, null, null));
	}
