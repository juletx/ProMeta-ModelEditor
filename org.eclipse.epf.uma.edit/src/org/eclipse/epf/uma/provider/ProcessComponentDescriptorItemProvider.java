...
public class ProcessComponentDescriptorItemProvider extends DescriptorItemProvider {
	...
	protected void add_processComponentPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ProcessComponentDescriptor__processComponent_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
								"_UI_ProcessComponentDescriptor__processComponent_feature", //$NON-NLS-1$
								"_UI_ProcessComponentDescriptor_type"), //$NON-NLS-1$
						UmaPackage.Literals.PROCESS_COMPONENT_DESCRIPTOR__PROCESS_COMPONENT, true, false, true, null,
						null, null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ProcessComponentDescriptor")); //$NON-NLS-1$
	}
