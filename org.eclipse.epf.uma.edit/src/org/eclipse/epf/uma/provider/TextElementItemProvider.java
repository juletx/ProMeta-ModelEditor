 ...
 * @generated
 */
public class TextElementItemProvider extends LeafElementItemProvider {
	/**
	...
	protected void addTextPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_TextElement_text_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_TextElement_text_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_TextElement_type"), //$NON-NLS-1$
						UmaPackage.Literals.TEXT_ELEMENT__TEXT, true, false, false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TextElement")); //$NON-NLS-1$
	}
