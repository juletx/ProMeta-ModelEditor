...
public class RoleSetGroupingItemProvider extends ContentCategoryItemProvider {
	...
	protected void addRoleSetsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_RoleSetGrouping_roleSets_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_RoleSetGrouping_roleSets_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_RoleSetGrouping_type"), //$NON-NLS-1$
						UmaPackage.Literals.ROLE_SET_GROUPING__ROLE_SETS, true, false, true, null, null, null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RoleSetGrouping")); //$NON-NLS-1$
	}
