...
public class ProcessItemProvider extends ActivityItemProvider {
	...
	protected void addIncludesPatternsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Process_includesPatterns_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_Process_includesPatterns_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_Process_type"), //$NON-NLS-1$
						UmaPackage.Literals.PROCESS__INCLUDES_PATTERNS, true, false, true, null, null, null));
	}
	...
	protected void addDefaultContextPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Process_defaultContext_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_Process_defaultContext_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_Process_type"), //$NON-NLS-1$
						UmaPackage.Literals.PROCESS__DEFAULT_CONTEXT, true, false, true, null, null, null));
	}
	...
	protected void addValidContextPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Process_validContext_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_Process_validContext_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_Process_type"), //$NON-NLS-1$
						UmaPackage.Literals.PROCESS__VALID_CONTEXT, true, false, true, null, null, null));
	}
