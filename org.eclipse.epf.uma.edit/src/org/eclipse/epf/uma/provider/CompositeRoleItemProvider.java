...
public class CompositeRoleItemProvider extends RoleDescriptorItemProvider {
	...
	protected void addAggregatedRolesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_CompositeRole_aggregatedRoles_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_CompositeRole_aggregatedRoles_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_CompositeRole_type"), //$NON-NLS-1$
						UmaPackage.Literals.COMPOSITE_ROLE__AGGREGATED_ROLES, true, false, true, null, null, null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CompositeRole")); //$NON-NLS-1$
	}
