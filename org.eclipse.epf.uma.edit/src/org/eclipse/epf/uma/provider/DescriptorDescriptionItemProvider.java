...
public class DescriptorDescriptionItemProvider extends BreakdownElementDescriptionItemProvider {
	...
	protected void addRefinedDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_DescriptorDescription_refinedDescription_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_DescriptorDescription_type"), //$NON-NLS-1$
				UmaPackage.Literals.DESCRIPTOR_DESCRIPTION__REFINED_DESCRIPTION, true, false, false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DescriptorDescription")); //$NON-NLS-1$
	}
