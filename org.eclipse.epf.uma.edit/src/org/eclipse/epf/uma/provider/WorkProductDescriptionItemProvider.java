...
public class WorkProductDescriptionItemProvider extends ContentDescriptionItemProvider {
	...
	protected void addPurposePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_WorkProductDescription_purpose_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_WorkProductDescription_purpose_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_WorkProductDescription_type"), //$NON-NLS-1$
						UmaPackage.Literals.WORK_PRODUCT_DESCRIPTION__PURPOSE, true, false, false,
	...
	protected void addImpactOfNotHavingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_WorkProductDescription_impactOfNotHaving_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_WorkProductDescription_type"), //$NON-NLS-1$
				UmaPackage.Literals.WORK_PRODUCT_DESCRIPTION__IMPACT_OF_NOT_HAVING, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addReasonsForNotNeedingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
						"_UI_WorkProductDescription_reasonsForNotNeeding_feature", "_UI_WorkProductDescription_type"), //$NON-NLS-1$ //$NON-NLS-2$
				UmaPackage.Literals.WORK_PRODUCT_DESCRIPTION__REASONS_FOR_NOT_NEEDING, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WorkProductDescription")); //$NON-NLS-1$
	}
