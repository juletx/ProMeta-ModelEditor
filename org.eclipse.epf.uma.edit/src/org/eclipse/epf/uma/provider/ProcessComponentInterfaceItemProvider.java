...
public class ProcessComponentInterfaceItemProvider extends BreakdownElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UmaPackage.eINSTANCE.getProcessComponentInterface_InterfaceSpecifications());
			childrenFeatures.add(UmaPackage.eINSTANCE.getProcessComponentInterface_InterfaceIO());
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ProcessComponentInterface"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ProcessComponentInterface_type") :
			getString("_UI_ProcessComponentInterface_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UmaPackage.eINSTANCE.getProcessComponentInterface_InterfaceSpecifications(),
				 UmaFactory.eINSTANCE.createTaskDescriptor()));

		newChildDescriptors.add
			(createChildParameter
				(UmaPackage.eINSTANCE.getProcessComponentInterface_InterfaceIO(),
