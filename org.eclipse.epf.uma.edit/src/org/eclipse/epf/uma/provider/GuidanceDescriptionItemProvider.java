...
public class GuidanceDescriptionItemProvider extends ContentDescriptionItemProvider {
	...
	protected void addAttachmentsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_GuidanceDescription_attachments_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_GuidanceDescription_attachments_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_GuidanceDescription_type"), //$NON-NLS-1$
						UmaPackage.Literals.GUIDANCE_DESCRIPTION__ATTACHMENTS, true, false, false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GuidanceDescription")); //$NON-NLS-1$
	}
