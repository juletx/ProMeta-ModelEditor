...
/**
 * This is the item provider adapter for a {@link uma.MethodLibrary} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MethodLibraryItemProvider extends MethodUnitItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UmaPackage.eINSTANCE.getMethodLibrary_MethodPlugins());
			childrenFeatures.add(UmaPackage.eINSTANCE.getMethodLibrary_PredefinedConfigurations());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UmaPackage.eINSTANCE.getMethodLibrary_MethodPlugins(),
				 UmaFactory.eINSTANCE.createMethodPlugin()));

		newChildDescriptors.add
			(createChildParameter
				(UmaPackage.eINSTANCE.getMethodLibrary_PredefinedConfigurations(),
