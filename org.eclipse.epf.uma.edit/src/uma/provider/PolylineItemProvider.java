...
/**
 * This is the item provider adapter for a {@link uma.Polyline} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PolylineItemProvider extends GraphicPrimitiveItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Polyline_closed_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Polyline_closed_feature", "_UI_Polyline_type"),
				 UmaPackage.eINSTANCE.getPolyline_Closed(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UmaPackage.eINSTANCE.getPolyline_Waypoints());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UmaPackage.eINSTANCE.getPolyline_Waypoints(),
