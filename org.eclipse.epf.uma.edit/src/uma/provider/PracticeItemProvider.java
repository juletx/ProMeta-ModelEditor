...
/**
 * This is the item provider adapter for a {@link uma.Practice} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PracticeItemProvider extends GuidanceItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Practice_contentReferences_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Practice_contentReferences_feature", "_UI_Practice_type"),
				 UmaPackage.eINSTANCE.getPractice_ContentReferences(),
				 true,
				 false,
				 true,
				 null,
	...
	protected void addActivityReferencesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Practice_activityReferences_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Practice_activityReferences_feature", "_UI_Practice_type"),
				 UmaPackage.eINSTANCE.getPractice_ActivityReferences(),
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UmaPackage.eINSTANCE.getPractice_SubPractices());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UmaPackage.eINSTANCE.getPractice_SubPractices(),
