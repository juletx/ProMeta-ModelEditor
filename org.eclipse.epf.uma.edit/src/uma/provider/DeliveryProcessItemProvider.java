...
/**
 * This is the item provider adapter for a {@link uma.DeliveryProcess} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DeliveryProcess_educationMaterials_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DeliveryProcess_educationMaterials_feature", "_UI_DeliveryProcess_type"),
				 UmaPackage.eINSTANCE.getDeliveryProcess_EducationMaterials(),
				 true,
				 false,
				 true,
				 null,
	...
	protected void addCommunicationsMaterialsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DeliveryProcess_communicationsMaterials_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DeliveryProcess_communicationsMaterials_feature", "_UI_DeliveryProcess_type"),
				 UmaPackage.eINSTANCE.getDeliveryProcess_CommunicationsMaterials(),
				 true,
				 false,
				 true,
				 null,
