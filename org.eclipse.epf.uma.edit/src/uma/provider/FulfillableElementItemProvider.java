...
/**
 * This is the item provider adapter for a {@link uma.FulfillableElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FulfillableElementItemProvider extends DescribableElementItemProvider {
	/**
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FulfillableElement"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_FulfillableElement_type") :
			getString("_UI_FulfillableElement_type") + " " + label;
	}
