...
/**
 * This is the item provider adapter for a {@link uma.EstimationConsiderations} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EstimationConsiderationsItemProvider extends GuidanceItemProvider {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EstimationConsiderations"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_EstimationConsiderations_type") :
			getString("_UI_EstimationConsiderations_type") + " " + label;
	}
